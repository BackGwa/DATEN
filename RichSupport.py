...
def syntaxerror(command, errcode):
    case = {'ukn' : f'{command}\nThis type of command is not supported!',
            ...
            'epi' : f'{command}\nEnter the path to the file to import!',
            'nds' : f'{command}\nNo database selected!',
            'dnc' : f'{command}\nThe database does not exist and cannot be imported!',
            'ifd' : f'{command}\nFailed to import database!',
            'exp' : f'{command}\nAn error has occurred! The path in the database is determined to have an error!'}
